...
/**
 * TODO: 
 *  - r?ajuster les timeout pour prendre valeurs de 802.11, taille de paquet... notamment temps de transmission, cca threshold...
 *  - v?rifier le backoff pour le difs au d?but ou direct backoff
 *  - tenter d'avoir diff?rentes longueurs de paqg?rer le multi-d?bit ????
 **/
