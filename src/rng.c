...
int rng_type(char *rng) {
     ...
     * and is known as the ?EURoeMersenne Twister?EUR? generator.
     ...
     * ?EURoeMersenne Twister: A 623-dimensionally equidistributed
     * uniform pseudorandom number generator?EUR?.
     * ACM Transactions on Modeling and Computer Simulation,
     * Vol. 8, No. 1 (Jan. 1998), Pages 3?EUR"30
     **/
    if (strcmp(rng, "mt19937") == 0) {
        /**
         * extract from GSL documentation:
         * The generator ranlxs0 is a second-generation version
         * of the ranlux algorithm of L? 1/4 scher, which produces
         * ?EURoeluxury random numbers?EUR?. This generator provides
         ...
         * developed by L? 1/4 scher. It uses a lagged-fibonacci-with-skipping algorithm
         * to produce ?EURoeluxury random numbers?EUR?. It is a 24-bit generator, originally
         ...
         * The default level of decorrelation recommended by L? 1/4 scher is provided by
